...
from core.data.dataset import Task74Dataset
from core.data.collators import Task74CollatorTest
...
# load dataset
test_dataset = Task74Dataset("dev", tokenizer=tokenizer)


collator_fn = Task74CollatorTest(device='cpu')
...
model = BertClassificationHead(model, model.config.hidden_size, num_classes=1,
                           drop=0.2, act='relu')
