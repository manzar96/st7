...
from core.data.dataset import Task7DatasetNegativeSampling
from core.data.collators import Task7NegativeSamplingCollator
from core.trainers import BertTrainerTripletMargin
...
# load dataset
dataset = Task7DatasetNegativeSampling("train", tokenizer=tokenizer)
train_dataset, val_dataset = torch.utils.data.random_split(dataset, [7200,
                                                                     800],
                              generator=torch.Generator().manual_seed(42))

collator_fn = Task7NegativeSamplingCollator(device='cpu')
...
trainer = BertTrainerTripletMargin(model=model, optimizer=optimizer, criterion=criterion,
